...
|---|---|
| Client | [`Procura-Frontend`](https://github.com/ProcuraAI-Org/Procura-Frontend) — React and Vite, [live](https://procura-frontend-steel.vercel.app) |
| x402 payment client | [`Procura-Backend`](https://github.com/ProcuraAI-Org/Procura-Backend), depending on `@x402/evm` and `@x402/fetch` |
...
| Settlement | [`Procura-Contracts`](https://github.com/ProcuraAI-Org/Procura-Contracts) — `AgentSettlementManager`, lifecycle `CREATED → AUTHORIZED → CONDITION_VERIFIED → SETTLED`, with `MockUSDC_EIP3009` for EIP-3009 `transferWithAuthorization` |
...
|---|---|---|---|
| [Grainlify/Grainlify-Frontend](https://github.com/Grainlify/Grainlify-Frontend) ([live](https://grainlify.com)) | 130 | 313 | 104 |
...
| [Stellopay/stellopay-frontend](https://github.com/Stellopay/stellopay-frontend) — payments frontend and merchant dashboard | 241 | 453 | 224 |
...
(Solana), [StableLink](https://github.com/Stable-link) (Etherlink), and
[Shadow-Settle](https://github.com/Shadow-Settle) (iExec confidential
computing).
